...
import { CgxLoggerColor } from '../types/logger-color.enum';

export class CGXLoggerUtils {
    ...
    static getColor(level: CgxLoggerLevel): CgxLoggerColor.BLUE | CgxLoggerColor.TEAL | CgxLoggerColor.GRAY | CgxLoggerColor.RED | undefined {
        switch (level) {
            case CgxLoggerLevel.TRACE:
                return CgxLoggerColor.BLUE;
            case CgxLoggerLevel.DEBUG:
                return CgxLoggerColor.TEAL;
            case CgxLoggerLevel.INFO:
            case CgxLoggerLevel.LOG:
                return CgxLoggerColor.GRAY;
            case CgxLoggerLevel.WARN:
            case CgxLoggerLevel.ERROR:
            case CgxLoggerLevel.FATAL:
                return CgxLoggerColor.RED;
            case CgxLoggerLevel.OFF:
            default:
                return;
        }
    }
